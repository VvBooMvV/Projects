...
public class AddressBookUtilityTest {
	...
	public void testContainsStringSTUDENT() {
		try {
			...
			assertEquals(true, addressBook.contains("(714)273-3813"));
			assertEquals(false, addressBook.contains("(801)553-8273"));
			assertEquals(false, addressBook.contains("(123)111-5555"));
			assertEquals(false, addressBook.contains("(456)333-5555"));
			assertEquals(false, addressBook.contains("(123)111-4672"));
			assertEquals(false, addressBook.contains("(123)456-554455"));
			assertEquals(false, addressBook.contains("(145)111-98741"));
		} catch (InvalidKeyException e) {
			// TODO Auto-generated catch block
			fail("This should not have raised an InvalidKeyException");
		}
		try {
			addressBook.contains("1234567");
			fail("This should have raised an InvalidKeyException ");
		} catch (InvalidKeyException e) {
			// TODO Auto-generated catch block
			// correct
		...
		try {
			addressBook.contains("951541-40111456");
			fail("This should have raised an InvalidKeyException ");
		} catch (InvalidKeyException e) {
			// TODO Auto-generated catch block
			// correct
	...
	public void testAddSTUDENT() {
		try {
			addressBook.add("Bobby", "Ass", "(222)273-3813", "UT");
			addressBook.add("Forv", "Live", "(111)273-3813", "UT");
			addressBook.add("Bluue", "Cheese", "(233)273-3813", "UT");
			addressBook.add("BK", "McDonald", "(345)273-3813", "UT");
		...
		try {
			...
			assertEquals(true, addressBook.contains("(615)387-3935"));
			assertEquals(true, addressBook.contains("(714)273-3813"));
			assertEquals(true, addressBook.contains("(345)273-3813"));
			assertEquals(true, addressBook.contains("(222)273-3813"));
			assertEquals(false, addressBook.contains("(801)553-8273"));
		} catch (InvalidKeyException e) {
			// TODO Auto-generated catch block
			fail("Should have not raised an InvalidKeyException");
	...
	public void testIsValidKey() {
		...
		try {
			assertEquals(false, addressBook.contains("(615)3873935"));
			fail("Should have raised an InvalidKeyException");
		} catch (InvalidKeyException e) {
			// TODO Auto-generated catch block
			// correct
		...
		try {
			assertEquals(false, addressBook.contains("7142733813"));
			fail("Should have raised an InvalidKeyException");
		} catch (InvalidKeyException e) {
			// TODO Auto-generated catch block
			// correct
	...
	public void testIsValidKeySTUDENT() {
		try {
			assertEquals(true, addressBook.isValidKey("(124)456-1112"));
			assertEquals(true, addressBook.isValidKey("(240)111-5846"));
		} catch (InvalidKeyException e) {
			// TODO Auto-generated catch block
			fail("Should have not raised an InvalidKeyException");
		}
		...
		try {
			assertEquals(true, addressBook.isValidKey("1234569870"));
			fail("Should have raised an InvalidKeyException");
		} catch (InvalidKeyException e) {
			// TODO Auto-generated catch block
			// correct
