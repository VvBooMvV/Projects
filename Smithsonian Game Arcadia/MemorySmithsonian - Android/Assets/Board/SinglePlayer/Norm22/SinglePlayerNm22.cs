...
public class SinglePlayerNm22 : MonoBehaviour {
	...
	//row 1
	public Button01Nm22 button1;
	public Button02Nm22 button2;
	public Button03Nm22 button3;
	public Button04Nm22 button4;
	
	//row 2
//	public Button05Nm33 button5;
//	public Button06Nm33 button6;
	//	public Button07Nm33 button7;
	//	public Button08Nm33 button8;
	//	
	//	//row 3
	//	public Button09Nm33 button9;
	//	public Button10Nm33 button10;
	...
	public void DealShuffledCards(){
		...
		int denom = 4;  //TODO size of the array from temp
		...
		int halfboardSize = 2;  //TODO this value should be equal to half the total board size; only thing that needs to change in this method
