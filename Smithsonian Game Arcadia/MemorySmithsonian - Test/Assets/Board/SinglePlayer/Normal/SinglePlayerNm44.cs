...
public class SinglePlayerNm44 : MonoBehaviour {
	...
	//row 1
	public Button01Nm button1;
	public Button02Nm button2;
	public Button03Nm button3;
	public Button04Nm button4;
	
	//row 2
	public Button05Nm button5;
	public Button06Nm button6;
	public Button07Nm button7;
	public Button08Nm button8;
	
	//row 3
	public Button09Nm button9;
	public Button10Nm button10;
	public Button11Nm button11;
	public Button12Nm button12;
...
//	public Button20FC button20;
	...
	public void DealShuffledCards(){
		...
		int denom = 16;  //size of the array from temp
		...
		int halfboardSize = 8;  //TODO this value should be equal to half the total board size; only thing that needs to change in this method
